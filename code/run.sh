...
# ./stippler.py original-data/plant2_400x400.png --force --save \
#               --n_point 20000 --n_iter 50 --pointsize 1.0 1.0 --figsize 6

# ./stippler.py original-data/plant5_700x700.png --force --save \
#               --n_point 20000 --n_iter 50 --pointsize 2.0 2.0 --figsize 8

# ./stippler.py original-data/plant4h.png --force --save \
#               --n_point 20000 --n_iter 50 --pointsize 1.5 1.5 --figsize 8

# ./stippler.py original-data/shoe_1300x1300_org.png --force --save \
#               --n_point 5000 --n_iter 50 --pointsize 3. 3. --figsize 6

# ./stippler.py data/boots.png --force --save \
#               --n_point 20000 --n_iter 50 --pointsize 1. 2. --figsize 6
